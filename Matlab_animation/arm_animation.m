...
n = numberOfFrames;
%theta1 = linspace(0, 75, n);
%theta2 = linspace(0, 120, n);
%theta3 = linspace(0, 20, n);
%theta4 = linspace(0, 80, n);

list = linspace(-150, -160, n);
for frameIndex = 1 : n
    cla reset;
    clf
    caption = sprintf('Frame #%d of %d, t = %.1f', frameIndex, numberOfFrames, t(frameIndex));
    title(caption, 'FontSize', 15);
    denavit_hartenberg( theta1(frameIndex), theta2(frameIndex), theta3(frameIndex), theta4(frameIndex));
    %view(0, 15)
    view(0, 90)
    drawnow;
